...
public class Activator implements BundleActivator {
	...
	/**
	 * Implements BundleActivator.start(). Crates a service tracker to monitor
	 * dictionary services and starts its "word checking loop". It will not be
	 * able to check any words until the service tracker find a dictionary
	 * service; any discovered dictionary service will be automatically used by
	 * the client. It reads words from standard input and checks for their
	 * existence in the discovered dictionary. (NOTE: It is very bad practice to
	 * use the calling thread to perform a lengthy process like this; this is
	 * only done for the purpose of the tutorial.)
	 * 
	 * @param context
