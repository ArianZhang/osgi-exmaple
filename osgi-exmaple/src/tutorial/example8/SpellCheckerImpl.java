...
/**
 * This class re-implements the spell checker service of Example 6. This service
 ...
 * availability, and only offers the spell checker service if there are
 * dictionary services available. The service implementation is greatly
 * simplified, though, by using the Service Binder. Notice that there is no OSGi
 * references in the application code; instead, the metadata.xml file describes
 * the service dependencies, which is read by the Service Binder to
 * automatically manage the dependencies and register the spell checker service
 * as appropriate.
 **/
